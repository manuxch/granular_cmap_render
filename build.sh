...
Descripción:
    Este script automatiza la compilación del programa que grafica sistemas granulares,
    un programa para visualización de trayectorias y mapas de calor 
...
Uso del programa después de compilar:
    ./build/granular_cmap_render --dir . --property presion -xylimits -10 10 -5 20    
    ./build/granular_cmap_render -h
        Descripción completa de argumentos

Repositorio: https://github.com/manuxch/granular_cmap_render 
EOF
}
...
if [ -f "granular_cmap_render" ]; then
    log_success "Ejecutable generado correctamente"
    echo ""
    log_info "Ejecutable: $BUILD_DIR/granular_cmap_render"
    log_info "Tamaño: $(du -h granular_cmap_render | cut -f1)"

    # Mostrar información del ejecutable
    echo ""
    log_info "Ejemplos de uso:"
    echo "  ./granular_cmap_render --dir . --property presion --cmap Greens --xylimits -10 10 -5 20"
    echo ""
else
